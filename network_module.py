...
class Net(L.LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        self.log("val_f1", 2 * (precision * recall) / (precision + recall + 1e-8), prog_bar=True, logger=True)
    ...
    def on_test_epoch_end(self):
        ...
        self.log("test_dice", dice, prog_bar=True, logger=True)
        self.log("test_iou", iou, prog_bar=True, logger=True)
        self.log("test_recall", recall, prog_bar=True, logger=True)
        self.log("test_precision", precision, prog_bar=True, logger=True)
        self.log("test_f1", 2 * (precision * recall) / (precision + recall + 1e-8), prog_bar=True, logger=True)
